...
class OfertaControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create ofertum" do
    assert_difference('Ofertum.count') do
      post oferta_url, params: { ofertum: { descripcion: @ofertum.descripcion, imagen: @ofertum.imagen, nombre: @ofertum.nombre, user_id: @ofertum.user_id } }
    end
  ...
  test "should update ofertum" do
    patch ofertum_url(@ofertum), params: { ofertum: { descripcion: @ofertum.descripcion, imagen: @ofertum.imagen, nombre: @ofertum.nombre, user_id: @ofertum.user_id } }
